...
> 📑 *vacancy_metrics.parquet* – содержат оценки и рейтинги вакансий по 9 различным вариантам определения топ, очень любопытные файлы как результат исследования  
> 📑 *vavancy_rangs.xlsx* – содержат оценки и рейтинги вакансий по 9 различным вариантам определения топ, очень любопытные файлы как результат исследования  
...
Для корректного отображения *Random_prediction.ipynb* пожалуйста пройдите по ссылке: <a href="https://nbviewer.org/github/Excellents1/recsys_job/blob/main/READY-MADE%20ALGORITHMS/Random_prediction.ipynb" target="_blank">Random_prediction.ipynb</a>
